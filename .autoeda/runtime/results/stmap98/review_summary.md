...
- supported stdin review pass 1: completed with exit `0`; no actionable correctness, build, stale-state, older-command regression, or diagnostic findings were reported.
...
- supported stdin review pass 2: completed with exit `0`; no remaining actionable correctness issues were reported.
